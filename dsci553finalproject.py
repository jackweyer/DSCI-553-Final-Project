...
"""
** Method Description:
I tried to use every feature I possibly could when constructing this model-based approach. I grabbed all of the easily available information for each business and user. Some of the special features I constructed were: 
* Extracting the top 20 most common business "categories" so businesses were further labeled
* Creating features for business Monday-Sunday hours open, opening time, and closing time
* Picking 20 "defining" common words in the tips file. Non-stop words.
* Encoding all of the "attributes" e.g. bike parking, open bar, good for kids, etc.
* I then tuned the 150+ features in an xgboost model
